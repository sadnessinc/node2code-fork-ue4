...
TSharedRef<FSlateStyleSet> N2CStyle::Create()
{
    ...
    Style->Set("NodeToCode.ExportButton",
        new N2C_PLUGIN_BRUSH(TEXT("export_arrow_green"), FVector2D(40.0f, 40.0f)));
    Style->Set("NodeToCode.ExportButton.Small",
        new N2C_PLUGIN_BRUSH(TEXT("export_arrow_green"), FVector2D(20.0f, 20.0f)));
    Style->Set("NodeToCode.ImportButton",
        new N2C_PLUGIN_BRUSH(TEXT("import_arrow_red"), FVector2D(40.0f, 40.0f)));
    Style->Set("NodeToCode.ImportButton.Small",
        new N2C_PLUGIN_BRUSH(TEXT("import_arrow_red"), FVector2D(20.0f, 20.0f)));

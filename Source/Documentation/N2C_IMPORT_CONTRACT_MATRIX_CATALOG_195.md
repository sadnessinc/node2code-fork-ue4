# Import contract matrix catalog — Version 195
...
Version 195 retains 117 rows and the same bounded coverage totals/four-phase intent, but several fixtures and verification rules were corrected during target-machine production testing. Durable import identities were retained where their authored semantic identity did not change. See `N2C_RELEASE_NOTES_195.md` and `N2C_INDEPENDENT_RELEASE_AUDIT_20260717.md`.
